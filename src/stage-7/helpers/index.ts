import {IFiber, IDom, IProps} from "../../stage-7/types";
...
export const clone = (fiber: IFiber): IFiber => {
    const {dom, type, props, hooks, parent, child} = fiber;
    return {
        dom,
        type,
        props,
...
export const createNewCompFiber = (fiber: IFiber) => {
    const {dom, type, props, hooks, parent, child} = fiber;
    return {
        dom,
        type,
