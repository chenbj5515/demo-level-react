...
b. [fre](https://github.com/yisar/fre)这个项目完成度很高，不过它是类React的框架而不是极简的React。它不是做减法，而是在React的基础上玩自己的想法。而我想要的是尽可能地掌控React，从而可以避免写bug，快速debug，写出性能更佳，符合React理念的代码——而不是造一个糅合了自己想法的玩具，即使那很酷。<br>
